...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Initial Catalog=AdventureWorks2019;Persist Security Info=False;User ID=sa;Password=Sa05423653954;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Personel__3213E83FFDD0C66F");
            ...
            entity.Property(e => e.Değistirmetarihi)
                .HasColumnType("datetime")
                .HasColumnName("değistirmetarihi");
            entity.Property(e => e.EmailAdresi)
                .HasMaxLength(100)
                .HasColumnName("emailAdresi");
            ...
            entity.Property(e => e.Silindimi).HasColumnName("silindimi");
