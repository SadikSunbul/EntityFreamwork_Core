...
class ApplicationDbContext : DbContext
{
    ...
    {
        #region Default Execution Strategy
        optionsBuilder.UseSqlServer("Server=localhost, 1433;Database=ApplicationDB;User ID=SA;Password=1q2w3e4r+!;TrustServerCertificate=True", builder => builder.EnableRetryOnFailure()); //baglantı kurmayı dener 3 dk boyunca sonra hata fırlatır
      optionsBuilder.UseSqlServer("Server=localhost, 1433;Database=ApplicationDB;User ID=SA;Password=1q2w3e4r+!;TrustServerCertificate=True", builder => builder.EnableRetryOnFailure(
            maxRetryCount: 5, //buraların default degerı var 
...
class CustomExecutionStrategy1 : ExecutionStrategy
{
    protected override bool ShouldRetryOn(Exception exception)
    {
