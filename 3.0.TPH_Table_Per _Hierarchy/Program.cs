...
//var employees = await context.Employees.ToListAsync();   //--->tecnısıon larda gelır bıze
...
class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=localhost,1433;Database=TPH;User Id=SA ; Password=sıfre*.;TrustServerCertificate=true");
