...
////...
////...
await context.Entry(employee).Reference(e => e.Region).LoadAsync();  //sonradan regıon ıhtıyacımz olursa bunu burda kullanırız ustekı ne regıonu eklerız 

//  await context.Employees.Include(e => e.Region).ToListAsync();  aynı ıslevı gorurler sadece bır ı gerektıgı zaman getırır verılerı
