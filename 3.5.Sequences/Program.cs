...
class ApplicationDbContext : DbContext
{
    ...
    {
        modelBuilder.HasSequence("EC_Sequence")  //burada urettık 
            .StartsAt(100)   //basla  buradan
            .IncrementsBy(5);  //aradakı fark kacra kacar 


        modelBuilder.Entity<Employee>()
            .Property(e => e.Id)
            .HasDefaultValueSql("NEXT VALUE FOR EC_Sequence"); //burlarda kullandık 
