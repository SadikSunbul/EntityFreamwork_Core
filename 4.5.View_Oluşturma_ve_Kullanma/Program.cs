...
class ApplicationDbContext : DbContext
{
    ...
    public DbSet<PersonOrder> PersonOrders { get; set; }  //EF CORE BUNUN VIEW OLDUGUNU ANLAMAZ TOVİEW ILE ISIMINI VERIRSEK ANLAR
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.ApplyConfigurationsFromAssembly(Assembly.GetExecutingAssembly());

        modelBuilder.Entity<PersonOrder>() //SORGULAMA DOGRU OLMASI ICN BUNU YAZMALIYDIK 
            .ToView("vm_PersonOrders")
            .HasNoKey();  //HERHANGI BIR PRIMARY KEY OLMIYCAK DEDIK
