...
var persons1 = await context.Persons.FromSql($"SELECT * FROM Persons")
.ToListAsync();
#endregion
...
#region Örnek 1
int personId = 3;
var persons4 = await context.Persons.FromSql($"SELECT * FROM Persons Where PersonId = {personId}")
    .ToListAsync();
...
personId5.DbType = System.Data.DbType.Int32;
personId5.Direction = System.Data.ParameterDirection.Input;

var persons5 = await context.Persons.FromSql($"SELECT * FROM Persons Where PersonId = {personId5}")
    .ToListAsync();
#endregion
#region Örnek 4
SqlParameter personId6 = new("PersonId", "3");
var persons6 = await context.Persons.FromSql($"EXECUTE dbo.sp_GetAllPersons {personId6}")
    .ToListAsync();
#endregion
#region Örnek 5
SqlParameter personId8 = new("PersonId", "3");
var persons8 = await context.Persons.FromSql($"EXECUTE dbo.sp_GetAllPersons @PersonId = {personId8}")
    .ToListAsync();
#endregion
#endregion
#endregion
