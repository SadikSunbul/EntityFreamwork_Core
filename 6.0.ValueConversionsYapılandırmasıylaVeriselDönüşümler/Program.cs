...
#endregion
#region İlkel Koleksiyonların Serilizasyonu ***********önemli
...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>()
            .Property(p => p.Gender)
            .HasConversion( //Dönüşüm Var dedık burada 
                            //INSERT - UPDATE
                g => g.ToUpper()  //kaydederken buyuk harf olarak kaydet degdık 
            ,
                //SELECT
                g => g == "M" ? "Male" : "Female"  //M ise MAle degılde Female getır dedık 
            );
        #endregion
        #region Enum Değerler İle Value Converter Kullanımı
        modelBuilder.Entity<Person>()
           ...
           ,
               //SELECT
               g => (Gender)Enum.Parse(typeof(Gender), g)  //enum turunuden donusturduk  
           );
        #endregion
        #region ValueConverter Sınıfı
