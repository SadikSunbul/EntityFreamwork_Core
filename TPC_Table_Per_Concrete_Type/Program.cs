...
abstract class Person  //bundan tablo olusturulmaz cunku bı yerden kalıtım almıyor burası concrete daegıl 
{
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>().UseTpcMappingStrategy();  //person ustunden tpc yap dedık 
    }
